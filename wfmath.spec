...
%description -l pl
Biblioteka matematyczna WorldForge. Skupia siê g³ównie na obiektach
geometrycznych.

%package devel
Summary:	Header files for WorldForge math library
Summary(pl):	Pliki nag³ówkowe biblioteki matematycznej WorldForge
...
Pliki nag³ówkowe biblioteki matematycznej WorldForge.
